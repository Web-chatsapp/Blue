    ...
    switch(packet.op){
      ...
      case "playerUpdate": 
        ...
        if (player){ 
          ...
          player.queue.current.info.poweredBy = `${this.blue.client.user.username}'s Development`;
      player.queue.current.info.uri = "https://open.spotify.com/";
      player.queue.current.info.sourceName = "Spotify";
